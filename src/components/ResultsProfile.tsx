...
export const ResultsProfile: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ageValue = storedAge ? parseInt(storedAge, 10) : 10;
    setAge(ageValue);

    // Fetch personalized feedback from Gemini via Server Action
    getPersonalizedFeedback(ageValue, 85).then(setFeedback);
  }, []);
