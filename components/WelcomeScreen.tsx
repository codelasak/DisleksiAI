    ...
    <div className="flex min-h-screen flex-col bg-bg-light p-6 text-text-main max-w-md mx-auto w-full">
      <header className="pt-8 pb-4">
        <div className="flex items-center justify-between">
          ...
          <button className="p-2 text-text-main hover:bg-gray-200 rounded-full transition-colors">
      ...
      <div className="mt-auto flex flex-col gap-3 pb-8">
        <button 
          onClick={() => onNavigate(AppView.AGE_SELECTION)}
          className="w-full bg-primary hover:bg-primary-dark text-white font-bold h-14 rounded-full text-lg transition-all shadow-lg shadow-primary/20 active:scale-[0.98]"
        >
          YENİ HESAP AÇMAK
        </button>
        <button className="w-full bg-blue-100 text-primary hover:bg-blue-200 font-bold h-14 rounded-full text-lg transition-colors">
          GİRİŞ YAPMAK
        </button>
